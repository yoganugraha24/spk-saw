...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active"><a href="alternatif.php"><i class="fa fa-tasks"></i> ALTERNATIF</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="margin-top:-30px;"><small>Alternatif</small></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<div class="well">
	<div class="row">
		...
		<div class="col-md-6 text-right">
			<button onClick="location.href='alternatif_baru.php'" class="btn btn-primary">Tambah Data</button>
		</div>
	</div>
	<br/>
...
?>
            <tr>
                ...
                <td class="text-center">
					<a href="alternatif_ubah.php?id=<?php echo $row['id_alternatif'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
					<a href="alternatif_hapus.php?id=<?php echo $row['id_alternatif'] ?>" onClick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
			    </td>
            </tr>
<?php
}
