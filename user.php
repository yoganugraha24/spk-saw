...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="margin-top:-30px;"><small>Data Pengguna</small></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<div class="well">
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            <button onClick="location.href='user_baru.php'" class="btn btn-primary">Tambah Data</button>
        </div>
    </div>
    <br/>
    ...
    ?>
            ...
            <td class="text-center">
    		  <a href="user_ubah.php?id=<?php echo $row['id_pengguna'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
    		  <a href="user_hapus.php?id=<?php echo $row['id_pengguna'] ?>" onClick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
    	    </td>
            </tr>
    <?php
    }
