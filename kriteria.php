...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active"><a href="kriteria.php"><i class="fa fa-bar-chart-o"></i> KRITERIA</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="margin-top:-30px;"><small>Kriteria</small></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<div class="well">
	<div class="row">
		...
		<div class="col-md-6 text-right">
			<button onClick="location.href='kriteria_baru.php'" class="btn btn-primary">Tambah Data</button>
		</div>
	</div>
	<br/>
...
?>
            <tr>
                ...
                <td class="text-center">
					<a href="kriteria_ubah.php?id=<?php echo $row['id_kriteria'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
					<a href="kriteria_hapus.php?id=<?php echo $row['id_kriteria'] ?>" onClick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
			    </td>
            </tr>
<?php
}
